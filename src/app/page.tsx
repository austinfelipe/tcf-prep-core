        ...
        <div className="mx-auto max-w-5xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card className="flex flex-col">
              ...
              <p className="mt-1 text-sm text-gray-500">
                Translate English phrases to French across CEFR levels.
              </p>
              <ul className="mt-4 space-y-2 text-sm text-gray-600">
                <li className="flex items-center gap-2">{CHECK_ICON} 100 phrases across A1–B2</li>
                <li className="flex items-center gap-2">{CHECK_ICON} Progressive difficulty</li>
              ...
              <div className="mt-auto pt-6">
                <Link href="/translation">
                  <Button variant="secondary" className="w-full">Start Translating</Button>
                </Link>
              </div>
            </Card>
